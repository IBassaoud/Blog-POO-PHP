...
<div class="min-h-screen flex flex-row bg-gray-100">
  ...
  <div class="flex items-center sticky top-[100vh] border-t-2 border-zinc-700 p-4">
    ...
    if(isset($_SESSION['admin'])){echo $_SESSION['admin']->getPrenom() . " " . $_SESSION['admin']->getNom();}
    if(isset($_SESSION['user'])){echo $_SESSION['user']->getPrenom() . " " . $_SESSION['user']->getNom();}
    if(isset($_SESSION['moderator'])){echo $_SESSION['moderator']->getPrenom() . " " . $_SESSION['moderator']->getNom();}
    ?></a>
